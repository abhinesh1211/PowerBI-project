...
-- 3 groupings
-- Aggregation by company_regions
SELECT 
    company_regions, 
    NULL AS company_division, 
    NULL AS gender, 
...
-- Aggregation by company_division
SELECT 
    NULL AS company_regions, 
    company_division, 
    NULL AS gender, 
...
----------- CUBE -------------------
-- Aggregation by company_division and company_regions
SELECT 
    company_division, 
    company_regions, 
    COUNT(*) AS total_employees
FROM vw_staff_div_reg
GROUP BY company_division, company_regions

UNION ALL

-- Aggregation by company_division only
SELECT 
    company_division, 
    NULL AS company_regions, 
    COUNT(*) AS total_employees
...
-- Aggregation by company_regions only
SELECT 
    NULL AS company_division, 
    company_regions, 
    COUNT(*) AS total_employees
